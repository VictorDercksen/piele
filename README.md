...
- `backtest`: the Jev backtest over past URC seasons (Phase F), using the API's state builder, Jev request, pick function and scoring. Baselines have been run; Jev runs need a TypeSafe API key. See [backtest/README.md](backtest/README.md).
